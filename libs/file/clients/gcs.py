...
#     """
#     def __init__(
# self, url: str, storage_options: Optional[dict[str, Any]] = None) -> None:
#         super().__init__(url, storage_options)
#         self.fs = fsspec.filesystem("gcs", **self.options)

#     def connect(self) -> None:
#         if self.connection:
#             return
#         # GCS usually expects 'token' for the credential path/dict
#         self.connection = fsspec.filesystem("gcs", **self.options)
