...
def find_keys_by_pattern(
    ...
    Args:
        ...
        ignore_case: If True, performs a case-insensitive match.

    Yields:
        Tuples of (path_string, value).
    """
    ...
    def _recurse(node: Any, current_path: str) -> Iterator[tuple[str, Any]]:
        if isinstance(node, dict):
            # Create a list snapshot to prevent RuntimeError if the dict is modified during iteration
