...
class DaemonJanitor:
    ...
    def evict_expired_run(
        self, record: "TaskStateView", task_context: Any | None = None
    ) -> None:
        """
        ...
        full_reason = f"{reason} | Scheduled: {record.scheduled_at}"
    ...
    def _evict_triggered_run(
        self, record: "TaskStateView", run_id: str, reason: str
    ) -> None:
    ...
    def _evict_untriggered_run(self, record: "TaskStateView", run_id: str) -> None:
