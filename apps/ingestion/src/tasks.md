...
Split Task into smaller components i.e TaskWorkspace, TaskState
...
2. The "Pre-Switch" Validation (Dry Run)
...
3. Cleanup Strategy: S3 vs. Server
...
4. PEX Layering Strategy (The "Cache" Check)
...
5. Multi-Container Deployment (Parallelism)
